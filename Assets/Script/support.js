...
const productInfo = [
  [
    ...
    ["colar", "ouro branco", "cravejado"],
    ["../Img/SVC-OB-C-01", "../Img/SVC-OB-C-02"],
  ],
  [
    "Serpenti Viper Colar",
    47900,
    "Interpretação ultramoderna do famoso ícone de glamour e sedução da Bvlgari, Serpenti Viper encanta com seu design inovador e de ponta. Evocando a cobra mítica por meio de formas geométricas e elegantes, este pingente se envolve ao redor da corrente, encantando com a beleza preciosa das escamas e com a sinuosidade inconfundível da coleção Serpenti. Colar Serpenti Viper em ouro rosa 18K e pavê de diamantes.",
    ["colar", "ouro rosa", "cravejado"],
    ["../Img/SVC-OR-C-01", "../Img/SVC-OR-C-02"],
  ],
  [
    "Serpenti Viper Colar",
    30200,
    "Interpretação ultramoderna do famoso ícone de glamour e sedução da Bvlgari, Serpenti Viper encanta com seu design inovador e de ponta. Evocando a cobra mítica por meio de formas geométricas e elegantes, este pingente se envolve ao redor da corrente, encantando com a beleza preciosa das escamas e com a sinuosidade inconfundível da coleção Serpenti. Colar Serpenti Viper em ouro rosa 18K semicravejado com pavê de diamantes.",
    ["colar", "ouro rosa", "semi-cravejado"],
    ["../Img/SVC-OR-SC-01", "../Img/SVC-OR-SC-02"],
  ],
  [
    "Serpenti Viper Colar",
    141000,
    ...
    ["colar", "ouro rosa", "semi-cravejado"],
    ["../Img/SVC-OR-SC-03", "../Img/SVC-OR-SC-04"],
  ],
  [
    "Serpenti Viper Colar",
    296000,
    ...
    ["colar", "ouro rosa", "cravejado"],
    ["../Img/SVC-OR-C-03", "../Img/SVC-OR-C-04"],
  ],
  [
    ...
    ["pulseira", "ouro branco", "cravejado"],
    ["../Img/SVP-OB-C-01", "../Img/SVP-OB-C-02"],
  ],
  [
    "Serpenti Viper Pulseira",
    186000,
    ...
    ["pulseira", "ouro rosa", "cravejado"],
    ["../Img/SVP-OR-C-01", "../Img/SVP-OR-C-02"],
  ],
  [
    "Serpenti Viper Pulseira",
    60000,
    ...
    ["pulseira", "ouro rosa", "semi-cravejado"],
    ["../Img/SVP-OR-SC-01", "../Img/SVP-OR-SC-02"],
  ],
  [
    "Serpenti Pulseira",
    269000,
    ...
    ["pulseira", "ouro rosa", "semi-cravejado"],
    ["../Img/SP-OR-SC-01", "../Img/SP-OR-SC-02"],
  ],
  [
    "Serpenti Viper Pulseira",
    186000,
    ...
    ["pulseira", "ouro amarelo", "cravejado"],
    ["../Img/SVP-OA-C-01", "../Img/SVP-OA-C-02"],
  ],
  [
    "Serpenti Viper Anel",
    51000,
    ...
    ["anel", "ouro amarelo", "cravejado"],
    ["../Img/SVA-OA-C-01", "../Img/SVA-OA-C-02"],
  ],
  [
    "Serpenti Viper Anel",
    51000,
    ...
    ["anel", "ouro rosa", "cravejado"],
    ["../Img/SVA-OR-C-01", "../Img/SVA-OR-C-02"],
  ],
  [
    "Serpenti Viper Anel",
    53000,
    ...
    ["anel", "ouro branco", "cravejado"],
    ["../Img/SVA-OB-C-01", "../Img/SVA-OB-C-02"],
  ],
  [
    "Serpenti Viper Anel",
    20200,
    ...
    ["anel", "ouro rosa", "semi-cravejado"],
    ["../Img/SVA-OR-SC-01", "../Img/SVA-OR-SC-02"],
  ],
  [
    "Serpenti Viper Anel",
    9850,
    ...
    ["anel", "ouro branco", "sem pedras"],
    ["../Img/SVA-OB-SP-01", "../Img/SVA-OB-SP-02"],
  ],
];
...
//// Classes
class Product {
  constructor(id, name, price, info, tags, imgSrc) {
    this.id = id;
    this.name = name;
    this.price = price;
    this.info = info;
...
for (let p of productInfo) {
  Products[`P${id}`] = new Product(id, p[0], p[1], p[2], p[3], p[4]);
  id++;
}
